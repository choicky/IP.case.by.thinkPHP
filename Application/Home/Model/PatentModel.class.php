...
class PatentModel extends RelationModel {
	...
	protected $_link = array(
		...
		'CaseType'	=>	array(							//本数据关联的名称
			...
			'class_name'		=>	'CaseTypeView',			//被关联的数据表
			'mapping_type'		=>	self::BELONGS_TO,	//属于关系一对一关联			
			'foreign_key'		=>	'case_type_id',		//外键，
			'mapping_fields'	=>	'case_type_name,case_group_name',	//关联字段
			'as_fields'			=>	'case_type_name,case_group_name'	//字段别名
		),
		...
		*/
		...
		'CasePriority'	=>	array(						//本数据关联的名称
			...
			'mapping_fields'	=>	'case_priority_id,priority_number,priority_country_id,priority_date,priority_country_id,priority_country_name',		//关联字段
