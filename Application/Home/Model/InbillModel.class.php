...
class InbillModel extends RelationModel {
	
	//定义本数据表的自动完成
	protected $_auto = array(		
		array('inbill_date','stringToTimestamp',3,'function') , // 将 yyyy-mm-dd 转换时间戳
		array('due_date','stringToTimestamp',3,'function') , // 将 yyyy-mm-dd 转换时间戳
	...
	protected $_validate = array(
		...
		array('supplier_id','require','必须指明供应商',1), //必须验证非空
